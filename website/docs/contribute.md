...
By contributing, you agree to the [OpenEverest code of conduct](https://github.com/openeverest/governance/blob/main/CODE_OF_CONDUCT.md).
...
If you find a bug in OpenEverest, you can submit a report via [GitHub Issues](https://github.com/openeverest/openeverest/issues).
...
1. Sign in to [GitHub](https://github.com). You will need to create an account if you do not have one.
2. Go to the [OpenEverest Issues page](https://github.com/openeverest/openeverest/issues) and click **New issue**.
...
If you’d like to submit a code patch, follow the [Contributing guide in the OpenEverest code repository](https://github.com/openeverest/openeverest/blob/main/CONTRIBUTING.md).
...
1. **Request a doc change through a GitHub issue**. If you've spotted a doc issue (a typo, broken links, inaccurate instructions, etc.) but don't have time or desire to fix it yourself, let us know about it.
   - Go to the [OpenEverest documentation repository issues page](https://github.com/openeverest/everest-doc/issues).
